module ApplicationHelper
  def get_twitter_card_info(hash)
    ...
    if hash.present?
      twitter_card[:url] = "https://bigtweet-techpit-20200110.herokuapp.com/?=#{hash}"
      twitter_card[:image] = "https://s3-ap-northeast-1.amazonaws.com/bigtweet-tawara-0110-#{environment}/images/#{hash}.png"
    else
      twitter_card[:url] = 'https://bigtweet-techpit-20200110.herokuapp.com/'
